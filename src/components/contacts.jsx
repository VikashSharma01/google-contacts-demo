        ...
        return ( 
            <div className = "hero-contact-list-class">
               <div className = "contact-list-class">
                ...
                <span className = "real-info">{this.props.value.first_name}</span>
                <span className = "real-info">{this.props.value.last_name}</span>
                <span className = "real-info">{this.props.value.email}</span>
                <span className = "real-info">{this.props.value.phone}</span>
